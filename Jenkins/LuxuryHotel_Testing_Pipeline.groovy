...
#Variable
  ...
  KubeW01_Pub_IP =
  KubeW02_Pub_IP =
  Prod_Workspace = /home/${User_Name}/workspace/LuxuryHotel_Production_Pipeline
  Build01_Pvt_IP =
...
pipeline {
    ...
    stages {
        ...
        stage('SCM_Checkout') {
            ...
            steps {
                ...
                git 'https://github.com/sameer-014-Devops/LuxuryHotel.git'
            }
            post {
                success {
                    script {
        ...
        stage ('Copy_Files_To_Production_Workspace'){
            ...
            steps{
                ...
                echo '**********Copied the Dockerfile, luxuryhoteldeploy.yaml, and target files to the LuxuryHotel Production workspace**********'
                cleanWs()
                deleteDir()
            }
        }
    ...
    post {
        success {
            build job: 'LuxuryHotel_Production_Pipeline', parameters: [string(name: 'new_ver', value: env.new_ver)]
